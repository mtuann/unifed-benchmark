...
def read_data(train_data_dir, test_data_dir):
    ...
    for f in test_files:
        ...
        my_numpy = np.array(pd.read_csv(file_path))
        if file_path[-8] == 'h':
            test_data['host']['x'],test_data['host']['y'] = my_numpy[:,2:],my_numpy[:,1]
        else:
            test_data['guest']['x'],test_data['guest']['y'] = my_numpy[:,2:],my_numpy[:,1]        
...
def load_partition_data_vehicle_scale_horizontal(batch_size,
                              train_path="../csv_data/vehicle_scale_horizontal_train/",
                              test_path="../csv_data/vehicle_scale_horizontal_train/"):
    ...
    class_num = 4 # to update the number of classes
